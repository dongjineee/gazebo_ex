...
ros::Publisher new_scan;
ros::Publisher new_scan_pointcloud_2;
...
int main(int argc, char** argv) {
    ...
    new_scan = nh.advertise<sensor_msgs::PointCloud>("/new_scan", 1);
    ...
    //새로운 tf에 대한 위치
    br.sendTransform(transformStamped);   //링크 생성
